...
int main(void)
{
  ...
  { 
    ...
    USART_SendText(USART3, "\tTIM3 and TIM4 blink green and blue LEDs, but TIM1 does not work to blink red LED???\n");    
...
void RCC_Setup()
{
  ...
  RCC_APB1PeriphClockCmd(RCC_APB1Periph_USART2 | RCC_APB1Periph_USART3 | RCC_APB1Periph_TIM3 | RCC_APB1Periph_TIM4, ENABLE);
