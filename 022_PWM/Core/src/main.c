...
int main(void) {
  ...
  while (1) {
    ...
    USART_SendText(USART3,
                   "\tTIM3, TIM4, and TIM1 blink green, blue, and RED LEDs\n");
...
void RCC_Setup() {
  ...
  RCC_APB1PeriphClockCmd(RCC_APB1Periph_USART2 | RCC_APB1Periph_USART3 |
                             RCC_APB1Periph_TIM3 | RCC_APB1Periph_TIM4,
                         ENABLE);
...
void TIMER_Setup(void) {
  ...
  TIM_OCInitStruct.TIM_OutputNState =
      TIM_OutputNState_Enable; // Just for timers 1 & 8
  TIM_OCInitStruct.TIM_OCPolarity = TIM_OCPolarity_High;
  TIM_OCInitStruct.TIM_OCNPolarity =
      TIM_OCPolarity_High; // Just for timers 1 & 8
  TIM_OCInitStruct.TIM_OCIdleState = TIM_OCIdleState_Reset;
  TIM_OCInitStruct.TIM_OCNIdleState =
      TIM_OCNIdleState_Reset; // Just for timers 1 & 8
